...
<template>
  ...
  <Section>
    ...
    <div v-if="session" class="text-gray-400 mb-5">
    ...
    <div>
      ...
      <div class="flex items-center gap-2">
        ...
        <button class="text-xs bg-gray-200 hover:bg-gray-300 p-1" @click="copyToClipboard(authUrl)">
          <svg
            width="20"
            height="20"
            viewBox="0 0 48 48"
    ...
    <div v-else>
      <div
        ...
        :key="snapshot.id"
        class="my-10 border-b pb-4 relative"
      >
