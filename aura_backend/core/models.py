...
class TemplateQuestionSnapshot(models.Model):
    ...
    template = models.ForeignKey(
        ApplicationTemplate, related_name="question_snapshots", on_delete=models.CASCADE
    )
...
class ApplicationAnswer(models.Model):
    ...
    session = models.ForeignKey(
        ApplicationSession, related_name="answers", on_delete=models.CASCADE
    )
    question_snapshot = models.ForeignKey(
        TemplateQuestionSnapshot, on_delete=models.PROTECT
    )
